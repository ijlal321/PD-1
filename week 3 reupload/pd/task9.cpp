...
{
int Final;
int num1,num2,num3,num4,num5,num6,num7,num8,num9,num10,num11,num12,num13,num14,num15,add,mul,sub;
cout <<"Enter number 1:  ";
cin >>num1;
cout <<"Enter number 2:  ";
cin >>num2;
...
sub=num15-num14-num13-num12-num11;
Final=(add+mul)-sub;
cout <<"Final output: "<<Final;
